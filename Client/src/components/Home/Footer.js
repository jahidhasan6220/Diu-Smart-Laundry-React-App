            ...
            <Container>
                <Row className="py-3">
                    <Col md={6} className="py-3">
                        ...
                        <h4 className="text-danger">DIU Smart Laundry Online Laundry Service</h4>
                        <p className="text-white">Email: smartlaundry.support@gmail.com</p>
                ...
                <div className='footer-bottom d-flex justify-content-center'>
                    <p className='text-secondary'>Copyright &copy; 2021 Developed by Salauddin Ayub & Jahid Hasan </p>
                </div>
            </Container>
        </footer>
    );
