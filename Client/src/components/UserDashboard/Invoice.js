	...
	return (
		<div className="print-container">
			<div className="d-flex justify-content-center mb-4">
				<h2 className="text-danger head-title mt-5">DIU Smart Laundry Online Laundry Service</h2>
			</div>
			<div className="row">
			...
			<div className="row">
				...
				<div className="col-md-5 mt-5">
					...
					<h4 className="text-dark">
						<i className="now-ui-icons ui-1_email-85" /> smartlaundry.support@gmail.com
					</h4>
				</div>
			</div>
		</div>
